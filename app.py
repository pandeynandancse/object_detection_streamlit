...
if img_file_buffer is not None:
    ...
    st.sidebar.image(image=np.asarray(image), use_column_width=True, 
...
st.image(
    image, caption=f"Annotated Image", use_column_width=True,
)
